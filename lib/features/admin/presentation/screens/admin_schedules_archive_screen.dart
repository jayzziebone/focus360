...
class AdminSchedulesArchiveScreen extends ConsumerStatefulWidget {
  const AdminSchedulesArchiveScreen({super.key});

  @override
  ConsumerState<AdminSchedulesArchiveScreen> createState() => _AdminSchedulesArchiveScreenState();
}

class _AdminSchedulesArchiveScreenState extends ConsumerState<AdminSchedulesArchiveScreen> {
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  if (matchingRecord.id.isNotEmpty && matchingRecord.punchInTime != null) ...[
                                    const SizedBox(height: 8),
